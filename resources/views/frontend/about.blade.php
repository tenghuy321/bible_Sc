...
@section('content')
    ...
    <div class="w-full h-[250px] md:h-[400px] xl:h-[1024px] xl:bg-fixed bg-center bg-cover"
        style="background-image: url('{{ asset('assets/images/Banners/about_4.png') }}');">
    </div>

    <div
        class="w-full max-w-[420px] md:max-w-[720px] xl:max-w-[1200px] mx-auto p-3 md:p-8 overflow-hidden">
        ...
        <p data-aos="fade-left" data-aos-duration="500"
            class="text-[14px] md:text-[20px] whitespace-pre-line">
