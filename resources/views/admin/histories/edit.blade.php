            ...
            <div class="w-full grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="p-0 space-y-4">
                    ...
                    <div>
                        ...
                        <input value="{{ old('title_en', $history->title_en) }}" type="text" name="title_en"
                ...
                <div class="p-0 space-y-4">
                    ...
                    <div>
                        ...
                        <input value="{{ old('title_kh', $history->title_kh) }}" type="text" name="title_kh"
                    ...
                    <div>
                        ...
                        <textarea name="content_kh" id="content_kh" rows="6"
                            class="mt-1 block w-full p-2 border rounded-md text-black text-[12px]">{{ old('content_kh', $history->content_kh) }}</textarea>
