<x-app-layout>
        ...
        <form action="{{ route('banner.update', $banner->id) }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="w-full grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="p-0 space-y-4">
                    ...
                    <div>
                        ...
                        <input value="{{ old('title_en', $banner->title_en) }}" type="text" name="title_en"
                ...
                <div class="p-0 space-y-4">
                    ...
                    <div>
                        ...
                        <input value="{{ old('title_kh', $banner->title_kh) }}" type="text" name="title_kh"
            ...
            <div>
                <label for="dropzone-file{{ $banner->id }}" id="drop-area"
                    ...
                    <input id="dropzone-file{{ $banner->id }}" type="file" class="hidden" name="images[]"
    ...
    <script>
        ...
        const fileInput = document.getElementById("dropzone-file{{ $banner->id }}");
