                            ...
                            <tr class="border-t border-[#4FC9EE]">
                                <td class="text-left py-3 px-4 text-[10px] md:text-[12px] border-r border-[#4FC9EE]">
                                    <div class="flex items-center h-full w-full">
                                        @php
                                            $images = json_decode($board->image, true); // decode to array
                                        @endphp
                                ...
                                <td class="py-3 px-4 text-xs border-r border-[#4FC9EE]">
                                    <div class="flex items-center space-x-1">
                                        {{-- <a href="{{ route('board.delete', $board->id) }}" title="Delete"
                                            onclick="event.preventDefault(); deleteRecord('{{ route('board.delete', $board->id) }}')">
                                        ...
                                        <a href="{{ route('board.edit', $board->id) }}" title="Edit">
