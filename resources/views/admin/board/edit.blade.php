<x-app-layout>
    <div class="max-w-4xl mx-auto bg-white shadow-md rounded-lg p-6 my-2">
        <h2 class="text-2xl font-bold">Edit Board</h2>
        <form action="{{ route('board.update', $board->id) }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="w-full grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="p-0 space-y-4">
                    ...
                    <div>
                        ...
                        <input value="{{ old('title_en', $board->title_en) }}" type="text" name="title_en"
                    ...
                    <div>
                        ...
                        <textarea name="content_en" id="content_en" rows="6"
                            class="mt-1 block w-full p-2 border rounded-md text-black text-[12px]">{{ old('content_en', $board->content_en) }}</textarea>
                ...
                <div class="p-0 space-y-4">
                    ...
                    <div>
                        ...
                        <input value="{{ old('title_kh', $board->title_kh) }}" type="text" name="title_kh"
                    ...
                    <div>
                        ...
                        <textarea name="content_kh" id="content_kh" rows="6"
                            class="mt-1 block w-full p-2 border rounded-md text-black text-[12px]">{{ old('content_kh', $board->content_kh) }}</textarea>
            ...
            <!-- Dropzone for Image -->
            <div>
                <label for="dropzone-file{{ $board->id }}" id="drop-area"
                    class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50">

                    <input id="dropzone-file{{ $board->id }}" type="file" class="hidden" name="images[]"
    ...
    <script>
        ...
        const fileInput = document.getElementById("dropzone-file{{ $board->id }}");
