        ...
        <form action="{{ route('catabook-backend.update', $catabook->id) }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input value="{{ old('type_km', $catabook->type_km) }}" type="text" name="type_en" id="type_km"
                        class="mt-1 block w-full p-2 border rounded-md text-[#000] text-sm">
                ...
                <div>
                    ...
                    <input value="{{ old('size_en', $catabook->size_en) }}" type="text" name="type_en" id="size_en"
                        class="mt-1 block w-full p-2 border rounded-md text-[#000] text-sm">
                ...
                <div>
                    ...
                    <input value="{{ old('size_km', $catabook->size_km) }}" type="text" name="type_en" id="size_km"
                        class="mt-1 block w-full p-2 border rounded-md text-[#000] text-sm">
            ...
            <div>
                ...
                <label for="dropzone-file{{ $catabook->id }}" id="drop-area"
                    ...
                    <div class="flex flex-col items-center justify-center pt-5 pb-6 w-full h-full bg-contain bg-center bg-no-repeat rounded-md text-center"
                        id="img-preview" style="background-image: url('{{ asset($catabook->image) }}')">
                    ...
                    <input id="dropzone-file{{ $catabook->id }}" type="file" class="hidden" name="image"
