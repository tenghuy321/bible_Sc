...
<x-app-layout>
    <div class="max-w-7xl mx-auto shadow-md rounded-lg p-6 my-2">
        <h2 class="text-2xl font-bold text-[#401457]">Edit Version</h2>
        <form action="{{ route('version-backend.update', $version->id) }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            @csrf
            @method('PATCH')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input value="{{ old('titleEn', $version->titleEn) }}" type="text" name="titleEn" id="titleEn"
                ...
                <div>
                    ...
                    <input value="{{ old('titleKm', $version->titleKm) }}" type="text" name="titleKm" id="titleKm"
                        class="mt-1 block w-full p-2 border rounded-md text-[#000] text-sm">
