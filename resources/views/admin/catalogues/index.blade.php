...
@section('content')
    <div class="my-3 md:my-4 text-end px-0 sm:px-2 md:px-4">
        <a href="{{ route('catalogues-backend.create') }}"
                        ...
                        <tr class="border border-[#4FC9EE]">
                            ...
                            <td class="py-4 px-4 text-xs max-w-[200px] border-r border-[#4FC9EE]">
                                <div class="flex flex-col truncate">
                                    <p>{{ $catalogue->name_en }}</p>
                                </div>
                            </td>

                            <td class="py-4 px-4 text-xs max-w-[200px] border-r border-[#4FC9EE]">
                                <div class="flex items-center space-x-2">
                                    <a href="{{ route('catalogues-backend.edit', $catalogue->id) }}" title="Edit">
                                    ...
                                    <a href="#" title="Delete"
                                        onclick="event.preventDefault(); deleteRecord('{{ route('catalogues-backend.delete', $catalogue->id) }}')">
