...
@section('content')
    <div class="">
        <div class="my-4 px-2 md:px-4 text-end">
            <a href="{{ route('mission_backend.create') }}"
                            ...
                            <tr class="border-t border-[#4FC9EE]">
                                <td class="text-left py-3 px-4 text-[10px] md:text-[12px] border-r border-[#4FC9EE]">
                                    <div class="flex items-center h-full w-full">
                                        @php
                                            $images = json_decode($mission->image, true); // decode to array
                                        @endphp
                                ...
                                <td class="py-3 px-4 text-xs border-r border-[#4FC9EE]">
                                    <div class="flex items-center space-x-1">
                                        <a href="{{ route('mission_backend.delete', $mission->id) }}" title="Delete"
                                            onclick="event.preventDefault(); deleteRecord('{{ route('mission_backend.delete', $mission->id) }}')">
                                        ...
                                        <a href="{{ route('mission_backend.edit', $mission->id) }}" title="Edit">
