<x-app-layout>
    <div class="max-w-7xl mx-auto shadow-md rounded-lg p-6 my-2">
        ...
        <form action="{{ route('readingdate.update', $reading->id) }}"  method="POST" enctype="multipart/form-data" class="space-y-4">
            @csrf
            @method('PATCH')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input value="{{ old('title_en', $reading->title_en) }}" type="text" name="title_en" id="title_en"
                ...
                <div>
                    ...
                    <input value="{{ old('title_km', $reading->title_km) }}" type="text" name="title_km" id="title_km"
                        class="mt-1 block w-full p-2 border rounded-md text-[#000] text-sm">
