        ...
        <nav class="sidebar close py-[2px] sm:py-[10px] px-[4px] sm:px-[14px]">
            ...
            <div class="menu-bar">
                <div class="menu max-h-[80vh] overflow-y-auto scrollbar-hidden">
                    <ul class="manu-links">
                        <li
                            class="nav-link {{ Route::is('dashboard') ? 'bg-[#4FC9EE] rounded-md !text-[#ffffff]' : '' }}">
                        ...
                        <li
                            class="nav-link {{ Request::is('version-backend') ? 'bg-[#4FC9EE] rounded-md !text-[#ffffff]' : '' }}">
                            <a href="{{ url('version-backend') }}">
                                <i class='bx bxl-vimeo icon'></i>
                                <span class="text nav-text">Version</span>
                            </a>
                        </li>
                        <li
                            class="nav-link {{ Request::is('vlog-backend') ? 'bg-[#4FC9EE] rounded-md !text-[#ffffff]' : '' }}">
                            <a href="{{ url('vlog-backend') }}">
                                <i class='bx bxl-blogger icon'></i>
                                <span class="text nav-text">Vlog</span>
                            </a>
                        </li>
                        <li
                            class="nav-link {{ Request::is('catalogues-backend') ? 'bg-[#4FC9EE] rounded-md !text-[#ffffff]' : '' }}">
                            <a href="{{ url('catalogues-backend') }}">
                                <i class='bx bxs-book-open icon'></i>
                                <span class="text nav-text">Catalogues</span>
                            </a>
                        </li>
                        <li
                            class="nav-link {{ Request::is('catabook-backend') ? 'bg-[#4FC9EE] rounded-md !text-[#ffffff]' : '' }}">
                            <a href="{{ url('catabook-backend') }}">
                                <i class='bx bxs-book-alt icon'></i>
                                <span class="text nav-text">Cata Book</span>
                            </a>
                        </li>
                        <li
                            class="nav-link {{ Request::is('readingdate') ? 'bg-[#4FC9EE] rounded-md !text-[#ffffff]' : '' }}">
                            <a href="{{ url('readingdate') }}">
                                <i class='bx bx-book-content icon'></i>
                                <span class="text nav-text">Reading Date</span>
                            </a>
                        </li>

                        <li
                            class="nav-link {{ Request::is('book') ? 'bg-[#4FC9EE] rounded-md !text-[#ffffff]' : '' }}">
                            <a href="{{ url('book') }}">
                                <i class='bx bxs-bible icon'></i>
                                <span class="text nav-text">Book</span>
                            </a>
                        </li>

                        <li
                            class="nav-link {{ Request::is('chapter') ? 'bg-[#4FC9EE] rounded-md !text-[#ffffff]' : '' }}">
                            <a href="{{ url('chapter') }}">
