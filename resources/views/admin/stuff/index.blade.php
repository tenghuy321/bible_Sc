                            ...
                            <tr class="border-t border-[#4FC9EE]">
                                <td class="text-left py-3 px-4 text-[10px] md:text-[12px] border-r border-[#4FC9EE]">
                                    <div class="flex items-center h-full w-full">
                                        @php
                                            $images = json_decode($stuff->image, true); // decode to array
                                        @endphp
                                ...
                                <td class="py-3 px-4 text-xs border-r border-[#4FC9EE]">
                                    <div class="flex items-center space-x-1">
                                        {{-- <a href="{{ route('stuff.delete', $stuff->id) }}" title="Delete"
                                            onclick="event.preventDefault(); deleteRecord('{{ route('stuff.delete', $stuff->id) }}')">
                                        ...
                                        <a href="{{ route('stuff.edit', $stuff->id) }}" title="Edit">
